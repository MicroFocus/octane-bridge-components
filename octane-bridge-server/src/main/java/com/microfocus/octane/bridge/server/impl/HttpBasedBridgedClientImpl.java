...
/**
 * HTTP based bridged client implementation is oriented towards an
 * underlying long/short HTTP polling connectivity mechanism
 *
 * @param <T>
 */

public class HttpBasedBridgedClientImpl<T> implements BridgedClient {

	HttpBasedBridgedClientImpl() {
